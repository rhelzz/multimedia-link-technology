    ...
    <main class="lg:pl-64">
        <div class="container mx-auto px-4 py-8 pb-16">
            <div class="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-xl">
                <h1 class="text-2xl font-bold mb-6">Create Hero Section</h1>
                ...
                <form action="{{ route('admin.hero-section.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="mb-4">
                        ...
                        <input id="title" name="title" type="text"
                               ...
                               value="{{ old('title', 'Internet Fiber Premium') }}">
                        @error('title')
                    ...
                    <fieldset class="mb-4">
                        ...
                        <input id="subtitle" name="subtitle" type="text"
                               class="block w-full rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none p-3 text-sm"
                               value="{{ old('subtitle', 'Untuk Kebutuhan Digital Anda') }}">
                        @error('subtitle')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </fieldset>
                    ...
                    <fieldset class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="3"
                                  class="block w-full rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none p-3 text-sm">{{ old('description', 'Nikmati kecepatan hingga 100 Mbps dengan stabilitas tinggi') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </fieldset>
                    ...
                    <fieldset class="mb-4">
                        ...
                        <input id="price_text" name="price_text" type="text"
                               class="block w-full rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none p-3 text-sm"
                               value="{{ old('price_text', 'Mulai dari Rp199.000/bulan') }}">
                        @error('price_text')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </fieldset>
                    ...
                    <fieldset class="mb-4">
                        ...
                        <input id="feature_tags" name="feature_tags" type="text"
                               class="block w-full rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none p-3 text-sm"
                               value="{{ old('featured_tags', 'Internet Cepat 24 Jam, Gratis Biaya Admin, Free Setup Modem WiFi') }}">
                        @error('feature_tags')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </fieldset>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                        ...
                        <fieldset>
                            ...
                            <input id="customer_rating" name="customer_rating" type="text"
                                   class="block w-full rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none p-3 text-sm"
                                   value="{{ old('customer_rating', '4.9/5') }}">
                        ...
                        <fieldset>
                            ...
                            <input id="active_customers" name="active_customers" type="text"
                                   class="block w-full rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none p-3 text-sm"
                                   value="{{ old('active_customers', '10.000+') }}">
                    ...
                    <fieldset class="mb-4">
                        ...
                        <input id="money_guarantee" name="money_guarantee" type="text"
                               class="block w-full rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none p-3 text-sm"
                               value="{{ old('money_guarantee', 'Jaminan Uang Kembali') }}">
