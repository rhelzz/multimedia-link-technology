...
<head>
    ...
    <title>Tambah Cabang Baru - Admin</title>
        ...
        <main class="lg:pl-64 py-10 px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                ...
                <div class="flex items-center justify-between mb-10">
                    <div>
                        <h1 class="text-3xl font-bold tracking-tight">Tambah Cabang Baru</h1>
                        <p class="text-gray-500 text-sm mt-1">Isi formulir di bawah untuk membuat cabang baru.</p>
                    </div>
