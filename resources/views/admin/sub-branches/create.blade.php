...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800">Tambah Lokasi untuk Cabang: {{ $branch->name }}</h1>
        </div>
                ...
                <form action="{{ route('admin.branches.sub-branches.store', $branch->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" name="subdistrict" id="subdistrict" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 @error('subdistrict') border-red-500 @enderror" value="{{ old('subdistrict') }}" required>
                            @error('subdistrict')
                        ...
                        <div>
                            ...
                            <input type="text" name="village" id="village" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 @error('village') border-red-500 @enderror" value="{{ old('village') }}" required>
                            @error('village')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <input type="text" name="postal_code" id="postal_code" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 @error('postal_code') border-red-500 @enderror" value="{{ old('postal_code') }}" required>
                            @error('postal_code')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        <div>
                            ...
                            <input type="text" name="whatsapp_number" id="whatsapp_number" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 @error('whatsapp_number') border-red-500 @enderror" value="{{ old('whatsapp_number') }}" placeholder="contoh: 6285850102226" required>
