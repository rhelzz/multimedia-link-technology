                ...
                <div class="flex items-center justify-between mb-10">
                    <div>
                        <h1 class="text-3xl font-bold tracking-tight">
                            {{ isset($feature) ? 'Edit Feature' : 'Create Feature' }}
                        </h1>
                        <p class="text-sm text-gray-500 mt-1">
                            {{ isset($feature) ? 'Update the selected feature below.' : 'Fill out the form to add a new feature.' }}
                        </p>
                    </div>
                ...
                >
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="description" name="description" rows="6"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none transition"
                                  placeholder="Describe the feature in detail..." required>{{ old('description', $feature->description ?? '') }}</textarea>
                        @error('description')
                            <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
