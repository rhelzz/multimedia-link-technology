...
<head>
    ...
    <title>Manage Additional Services</title>
        ...
        <main class="lg:pl-64 py-10 px-4 sm:px-6 lg:px-8">
            <div class="max-w-6xl mx-auto">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Manage Additional Services</h1>
                        <p class="text-sm text-gray-500 mt-1">List of all additional services available in the system.</p>
                    </div>
                    <a href="{{ route('admin.additional-services.create') }}"
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm">
                            @forelse ($services as $service)
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-6 py-4">
                                        <img src="{{ asset('storage/' . $service->image) }}" alt="{{ $service->title }}" class="w-16 h-16 object-cover rounded">
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4 text-center whitespace-nowrap">
                                        <div class="flex items-center justify-center gap-3">
                                            <a href="{{ route('admin.additional-services.edit', $service->id) }}"
                                               class="text-blue-600 hover:underline">✏️ Edit</a>
                                            <form action="{{ route('admin.additional-services.destroy', $service->id) }}"
                                ...
                                <tr>
                                    <td colspan="7" class="text-center px-6 py-10 text-gray-500">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="font-semibold text-lg">No additional services found</p>
